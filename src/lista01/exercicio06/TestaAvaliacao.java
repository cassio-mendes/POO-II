...
public class TestaAvaliacao {
    ...
    static void main(String[] args) {
        ...
        //Parâmetros
        Atividade[] atividades = {Atividade.PROJETO, Atividade.TRABALHO, Atividade.PROVA_PRATICA,
                Atividade.PROVA_TEORICA};
        try {
            String resposta = Atividade.calcularMediaPonderada(atividades, 8.0, 6.0, 5.5, 7.0);
            System.out.println(resposta); //Resultado final

        } catch(PesosInvalidosException | ValorInvalidoException | ArrayIndexOutOfBoundsException e) {
